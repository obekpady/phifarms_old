				...
				<div class="row">
					<div class="col-lg-4 col-md-4">
						<div class="clv_left_header"> 
							<div class="clv_logo">
								<a href="index.html"><img src="{{asset('frontend/assets/images/logo1.png')}}" alt="Poultry Farming" /></a>
							</div>
						</div>
					</div>
								...
								<div class="row">
									<div class="col-md-4">
										<div class="address_block">
											...
											<p>Behind Aco Estate Gbaupe, Airport Road Abuja.</p>
										</div>
									</div>
									<div class="col-md-4">
										<div class="address_block">
									...
									<div class="col-md-4">
										<div class="address_block">
											...
											<p>poultryfarming@example.com</p>
										</div>
									</div>
								</div>
							</div>
									...
									<ul>
										...
										<li>
											<a class="cart_toggle" href="javascript:;">
												...
												<path fill-rule="evenodd"  fill="#9dc709"
											...
											<div class="clv_cart_box">
												...
												<a href="cart.html" class="cart_action_btn">check out</a>
											</div>
										</li>
